            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Button
                  ...
                  className="group bg-primary hover:bg-primary/90 h-auto cursor-pointer flex-col gap-2 p-6"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="group hover:bg-muted h-auto cursor-pointer flex-col gap-2 p-6"
                >
